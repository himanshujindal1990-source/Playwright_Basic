...
```
TypeError: login.clickLogingButton is not a function
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: Himanshujindal
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox [active] [ref=e15]: "123"
        - generic [ref=e17]:
...
```ts
  ...
  9  |          
  10 |         await login.clickLoginLink();
  11 |         await login.fillUserName("Himanshujindal");
  12 |         await login.fillPassword("123");
> 13 |         await login.clickLogingButton();
     |                     ^ TypeError: login.clickLogingButton is not a function
  14 |  
  15 |         
  16 |         
