...
```ts
  ...
  7  | 
  8  | const login:any = new LoginPage(page); // created a object for LoginPage class.
  9  |          
  10 |         await login.clickLoginLink();
  11 |         await login.fillUserName("Himanshujindal");
  12 |         await login.fillPassword("12345");
  13 |         await login.clickLoginButton();
